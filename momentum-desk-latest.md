# Momentum Desk — Daily Report (2026-08-14)
...
- 52-week breakouts vs breakdowns today: 20 breakouts / 2 breakdowns (out of 520 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 70 | 52% | 8 |
| Health Care | 60 | 68 | 48% | 23 |
| Information Technology | 90 | 62 | 47% | 24 |
| Financials | 70 | 58 | 39% | 30 |
| Industrials | 77 | 57 | 32% | 20 |
| Consumer Discretionary | 53 | 35 | 23% | 9 |
| Materials | 26 | 46 | 19% | 7 |
| Communication Services | 24 | 44 | 12% | 2 |
| Real Estate | 31 | 44 | 6% | 2 |
| Consumer Staples | 31 | 31 | 0% | 6 |
| Utilities | 31 | 29 | 0% | 3 |
| Unknown | 3 | 6 | 0% | 0 |

**Leading theme: Energy** — 52% of its 21 scanned names carry an RS score of 70+, and 8 name(s) are clearing a screen outright today.

## 3. Leading Stocks

**Leader spotlight** — the strongest names driving today's leading themes:

- **DELL** (Information Technology) — RS 99.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=DELL)
...
**Momentum screen (Qullamaggie-style):**
  - ADR%: 6.6% (needs >= 3.0% volatility to qualify)
...
### WDAY — Information Technology [chart](https://www.tradingview.com/chart/?symbol=WDAY)
- Screens passed: B (Momentum)
- Setup: Continuation breakout (confirmed)
- Pivot (breakout trigger level): 184.19
- Entry: next session's open (pivot 184.19 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 1.57x
- ADR%: 6.4% | RS score: 85.0
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.57x the 50-day average (needs >= 1.5x)

</details>

### Q — Information Technology [chart](https://www.tradingview.com/chart/?symbol=Q)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 190.11
- Entry: next session's open, only if volume confirms (price is already above pivot 190.11 on light volume)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 162.93
- Entry: next session's open, only if volume confirms (price is already above pivot 162.93 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.34x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 138.73
- Entry: next session's open, only if volume confirms (price is already above pivot 138.73 on light volume)
- Volume vs 50-day avg: 0.55x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.29x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 255.46
- Entry: next session's open, only if volume confirms (price is already above pivot 255.46 on light volume)
- Volume vs 50-day avg: 0.29x
- ADR%: 1.4% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 58.01
- Entry: next session's open, only if volume confirms (price is already above pivot 58.01 on light volume)
- Volume vs 50-day avg: 0.61x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.51x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 253.55
- Entry: next session's open, only if volume confirms (price is already above pivot 253.55 on light volume)
- Volume vs 50-day avg: 0.51x
- ADR%: 1.5% | RS score: 81.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 23.55
- Entry: pivot 23.55 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.86x
- ADR%: 1.8% | RS score: 68.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: Cleared pivot on light volume (unconfirmed — 0.42x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 52.99
- Entry: next session's open, only if volume confirms (price is already above pivot 52.99 on light volume)
- Volume vs 50-day avg: 0.42x
- ADR%: 1.6% | RS score: 60.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### TROW — Financials [chart](https://www.tradingview.com/chart/?symbol=TROW)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 121.68
- Entry: pivot 121.68 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.47x
- ADR%: 2.2% | RS score: 52.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### V — Financials [chart](https://www.tradingview.com/chart/?symbol=V)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 369.78
- Entry: pivot 369.78 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.48x
- ADR%: 1.8% | RS score: 51.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### JBHT — Industrials [chart](https://www.tradingview.com/chart/?symbol=JBHT)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 216.53
- Entry: pivot 216.53 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.54x
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 227.68
- Entry: pivot 227.68 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.35x
- ADR%: 2.5% | RS score: 64.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 108.55
- Entry: pivot 108.55 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.47x
...
- Entry: pivot 70.51 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.56x
...
**Trend Template: 5/8 criteria met**
  ...
  - ✅ Price within 25% of its 52-week high
  - ❌ RS score >= 70
  - RS score used: 37.0 (needs >= 70 for criterion 8)
**Momentum screen (Qullamaggie-style):**
  - ADR%: 2.6% (needs >= 3.0% volatility to qualify)
  - RS score: 37.0 (needs >= 80 for this screen)
  - Riding the trend: no
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 89.08
- Entry: pivot 89.08 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.32x
- ADR%: 1.6% | RS score: 63.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 126.35
- Entry: pivot 126.35 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.59x
- ADR%: 2.4% | RS score: 62.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### MDLZ — Consumer Staples [chart](https://www.tradingview.com/chart/?symbol=MDLZ)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 64.99
- Entry: pivot 64.99 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.41x
- ADR%: 2.1% | RS score: 40.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Trend Template: 6/8 criteria met**
  ...
  - ✅ Price within 25% of its 52-week high
  - ❌ RS score >= 70
  - RS score used: 40.0 (needs >= 70 for criterion 8)
**Momentum screen (Qullamaggie-style):**
  - ADR%: 2.1% (needs >= 3.0% volatility to qualify)
  - RS score: 40.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.

</details>

### BF.B — Consumer Staples [chart](https://www.tradingview.com/chart/?symbol=BF.B)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 29.52
- Entry: pivot 29.52 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.37x
- ADR%: 3.0% | RS score: 30.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### PG — Consumer Staples [chart](https://www.tradingview.com/chart/?symbol=PG)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 148.88
- Entry: pivot 148.88 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.82x
- ADR%: 1.8% | RS score: 20.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### EVRG — Utilities [chart](https://www.tradingview.com/chart/?symbol=EVRG)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
...
### AES — Utilities [chart](https://www.tradingview.com/chart/?symbol=AES)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
...
### ATO — Utilities [chart](https://www.tradingview.com/chart/?symbol=ATO)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 179.38
- Entry: pivot 179.38 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.56x
- ADR%: 1.6% | RS score: 18.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
Market regime reads **constructive**, and **Energy** is leading with 52% of its names carrying RS 70+ and 8 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:
...
- **STT** (Financials) — Cleared pivot on light volume (unconfirmed — 0.27x avg, needs 1.5x) [VCP-Pivot], RS 92.0, pivot 190.11. Entry: next session's open, only if volume confirms (price is already above pivot 190.11 on light volume). [chart](https://www.tradingview.com/chart/?symbol=STT)
