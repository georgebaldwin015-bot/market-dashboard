# Momentum Desk — Daily Report (2026-08-27)
...
The market is holding an uptrend but losing some of its edge, with breadth reading 59% of the scanned universe above its 50-day moving average and a manageable 4 distribution days in the past month. Zooming out, breadth has been improving over the last 60 sessions (+7.0 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-10.0 pt), while SPY is roughly flat (+1.1% over 60 sessions, -1.5% over the last two weeks). That trend is broadly consistent with today's snapshot, not diverging from it. Momentum under the surface is leaning firmly long -- 13 name(s) hit a fresh 52-week high today against 4 breaking down to a fresh 52-week low. Energy is leading, with 57% of its 21 scanned names carrying an RS score of 70+ and 11 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like VLO, MPC and PSX. With 84 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 766.08 | 10-day MA: 768.72 | 20-day MA: 766.63

**Caution** — 10-day above 20-day but losing upward slope. Trade smaller, tighter.

- Breadth: 59% of the scanned universe above its 50-day MA, 72% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 13 breakouts / 4 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 71 | 57% | 11 |
| Health Care | 60 | 73 | 53% | 28 |
| Information Technology | 90 | 62 | 44% | 29 |
| Financials | 70 | 59 | 34% | 26 |
| Industrials | 77 | 53 | 29% | 35 |
| Materials | 26 | 53 | 27% | 10 |
| Consumer Discretionary | 53 | 36 | 19% | 13 |
| Real Estate | 29 | 43 | 14% | 9 |
| Communication Services | 22 | 37 | 9% | 2 |
| Consumer Staples | 31 | 38 | 6% | 5 |
| Utilities | 31 | 25 | 0% | 8 |
| Unknown | 3 | 5 | 0% | 0 |

**Leading theme: Energy** — 57% of its 21 scanned names carry an RS score of 70+, and 11 name(s) are clearing a screen outright today.
...
- **LITE** (Information Technology) — RS 98.0, Cleared pivot on light volume (unconfirmed — 0.91x avg, needs 1.5x) [VCP-Pivot], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=LITE)
- **DELL** (Information Technology) — RS 98.0, VCP contraction (watch for trigger) [VCP-Watch], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=DELL)
...
- Pivot (breakout trigger level): 350.05
- Entry: pivot 350.05 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.75x
- ADR%: 3.4% | RS score: 97.0
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 365.21
- Entry: pivot 365.21 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 243.49
- Entry: pivot 243.49 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 44.39
- Entry: pivot 44.39 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.73x
- ADR%: 3.4% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 134.89
- Entry: pivot 134.89 (not yet cleared -- still a live trigger level to watch for)
...
- Pivot (breakout trigger level): 205.77
- Entry: pivot 205.77 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.81x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 153.05
- Entry: pivot 153.05 (not yet cleared -- still a live trigger level to watch for)
...
- Volume vs 50-day avg: 1.34x
- ADR%: 9.6% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  - ADR%: 9.6% (needs >= 3.0% volatility to qualify)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.32x avg, needs 1.5x)
- Pattern tag: Flag-Pivot
- Pivot (breakout trigger level): 234.8
- Entry: next session's open, only if volume confirms (price is already above pivot 234.8 on light volume)
- Volume vs 50-day avg: 1.32x
- ADR%: 3.6% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: pivot 67.47 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.75x
...
- Pivot (breakout trigger level): 389.71
- Entry: next session's open, only if volume confirms (price is already above pivot 389.71 on light volume)
- Volume vs 50-day avg: 0.64x
- ADR%: 3.5% | RS score: 94.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: pivot 443.84 (not yet cleared -- still a live trigger level to watch for)
...
- Pivot (breakout trigger level): 24.77
- Entry: next session's open, only if volume confirms (price is already above pivot 24.77 on light volume)
- Volume vs 50-day avg: 0.77x
- ADR%: 3.7% | RS score: 87.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.77x avg, needs 1.5x)
- Pivot (breakout trigger level): 124.84
- Entry: next session's open, only if volume confirms (price is already above pivot 124.84 on light volume)
- Volume vs 50-day avg: 0.77x
- ADR%: 3.2% | RS score: 87.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 244.51
- Entry: next session's open, only if volume confirms (price is already above pivot 244.51 on light volume)
- Volume vs 50-day avg: 0.84x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 17.69
- Entry: pivot 17.69 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.74x
- ADR%: 2.8% | RS score: 85.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 273.14
- Entry: pivot 273.14 (not yet cleared -- still a live trigger level to watch for)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 75.14
- Entry: next session's open, only if volume confirms (price is already above pivot 75.14 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 339.34
- Entry: pivot 339.34 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.0x
- ADR%: 2.4% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 552.85
- Entry: pivot 552.85 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 240.26
- Entry: pivot 240.26 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.67x
- ADR%: 2.6% | RS score: 80.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 1280.34
- Entry: pivot 1280.34 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.06x
- ADR%: 3.4% | RS score: 79.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 890.17 on light volume)
- Volume vs 50-day avg: 0.91x
- ADR%: 8.8% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  - ADR%: 8.8% (needs >= 3.0% volatility to qualify)
...
- Entry: pivot 494.51 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.52x avg, needs 1.5x)
- Pattern tag: Flag-Pivot
- Pivot (breakout trigger level): 234.33
- Entry: next session's open, only if volume confirms (price is already above pivot 234.33 on light volume)
- Volume vs 50-day avg: 0.52x
- ADR%: 6.2% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 168.29
- Entry: pivot 168.29 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.55x
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 190.51
- Entry: next session's open, only if volume confirms (price is already above pivot 190.51 on light volume)
- Volume vs 50-day avg: 0.96x
- ADR%: 4.5% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 293.82
- Entry: next session's open, only if volume confirms (price is already above pivot 293.82 on light volume)
- Volume vs 50-day avg: 0.72x
- ADR%: 3.6% | RS score: 91.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 172.24
- Entry: pivot 172.24 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.83x
- ADR%: 3.4% | RS score: 74.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 193.04 on light volume)
- Volume vs 50-day avg: 0.48x
- ADR%: 2.0% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 98.19
- Entry: pivot 98.19 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.66x
- ADR%: 3.2% | RS score: 90.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: Cleared pivot on light volume (unconfirmed — 0.72x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 32.72
- Entry: next session's open, only if volume confirms (price is already above pivot 32.72 on light volume)
- Volume vs 50-day avg: 0.72x
- ADR%: 2.6% | RS score: 89.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 35.77
- Entry: pivot 35.77 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.45x
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 389.01
- Entry: pivot 389.01 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 275.11
- Entry: pivot 275.11 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 301.57
- Entry: pivot 301.57 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.74x
...
- Entry: pivot 115.41 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.57x
- ADR%: 1.8% | RS score: 78.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.57x avg, needs 1.5x)
- Pivot (breakout trigger level): 189.05
- Entry: next session's open, only if volume confirms (price is already above pivot 189.05 on light volume)
- Volume vs 50-day avg: 0.57x
- ADR%: 2.6% | RS score: 88.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.57x avg, needs 1.5x)
- Pivot (breakout trigger level): 51.59
- Entry: next session's open, only if volume confirms (price is already above pivot 51.59 on light volume)
- Volume vs 50-day avg: 0.57x
- ADR%: 1.8% | RS score: 87.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 300.34
- Entry: next session's open, only if volume confirms (price is already above pivot 300.34 on light volume)
- Volume vs 50-day avg: 0.7x
- ADR%: 1.9% | RS score: 86.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 309.86
- Entry: next session's open, only if volume confirms (price is already above pivot 309.86 on light volume)
- Volume vs 50-day avg: 0.86x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 240.52
- Entry: pivot 240.52 (not yet cleared -- still a live trigger level to watch for)
...
### PH — Industrials [chart](https://www.tradingview.com/chart/?symbol=PH)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 1073.87
- Entry: pivot 1073.87 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 648.64
- Entry: pivot 648.64 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.7x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 274.74
- Entry: pivot 274.74 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.69x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 129.6
- Entry: pivot 129.6 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.77x
- ADR%: 3.7% | RS score: 87.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 49.57
- Entry: pivot 49.57 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.63x
...
- Setup: Cleared pivot on light volume (unconfirmed — 0.77x avg, needs 1.5x)
- Pattern tag: Flag-Pivot
- Pivot (breakout trigger level): 153.01
- Entry: next session's open, only if volume confirms (price is already above pivot 153.01 on light volume)
- Volume vs 50-day avg: 0.77x
...
### ROST — Consumer Discretionary [chart](https://www.tradingview.com/chart/?symbol=ROST)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 255.23
- Entry: pivot 255.23 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.86x
- ADR%: 2.2% | RS score: 78.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Volume vs 50-day avg: 2.27x
- ADR%: 2.8% | RS score: 72.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 241.15
- Entry: next session's open, only if volume confirms (price is already above pivot 241.15 on light volume)
- Volume vs 50-day avg: 0.74x
...
### DOC — Real Estate [chart](https://www.tradingview.com/chart/?symbol=DOC)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 22.37
- Entry: pivot 22.37 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.71x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 1096.86
- Entry: pivot 1096.86 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.83x
- ADR%: 2.9% | RS score: 71.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 125.87
- Entry: next session's open (pivot 125.87 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 2.02x
- ADR%: 2.4% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 82.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 2.02x the 50-day average (needs >= 1.5x)
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.
...
Market regime reads **caution**, and **Energy** is leading with 57% of its names carrying RS 70+ and 11 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:
...
- **DELL** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 98.0, pivot 494.51. Entry: pivot 494.51 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=DELL)
- **VLO** (Energy) — VCP contraction (watch for trigger), RS 97.0, pivot 350.05. Entry: pivot 350.05 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=VLO)
...
- **MPC** (Energy) — VCP contraction (watch for trigger), RS 96.0, pivot 365.21. Entry: pivot 365.21 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MPC)
- **FTNT** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 96.0, pivot 168.29. Entry: pivot 168.29 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=FTNT)
- **PSX** (Energy) — VCP contraction (watch for trigger), RS 95.0, pivot 243.49. Entry: pivot 243.49 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=PSX)
- **NTAP** (Information Technology) — VCP contraction (watch for trigger) [Flag-Watch], RS 95.0, pivot 207.08. Entry: pivot 207.08 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=NTAP)

## 5. Other Setups (context)


**Extended / parabolic-short context (not a trade signal by itself):**
- MRNA (Health Care) [chart](https://www.tradingview.com/chart/?symbol=MRNA) — 103.6% above 50-day MA, +135.1% over the last 10 sessions.
