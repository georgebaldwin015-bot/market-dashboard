# Momentum Desk — Daily Report (2026-08-04)
...
SPY close: 771.33 | 10-day MA: 745.17 | 20-day MA: 747.20
...
| Consumer Discretionary | 53 | 33 | 21% | 10 |
| Real Estate | 31 | 49 | 19% | 6 |
| Consumer Staples | 31 | 41 | 6% | 2 |
| Utilities | 31 | 33 | 0% | 1 |
| Unknown | 3 | 5 | 0% | 0 |

**Leading theme: Information Technology** — 47% of its 90 scanned names carry an RS score of 70+, and 20 name(s) are clearing a screen outright today.

## 3. Leading Stocks

**Leader spotlight** — the strongest names driving today's leading themes:

- **ZBRA** (Information Technology) — RS 91.0, Continuation breakout (confirmed) [Episodic Pivot-Breakout], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=ZBRA)
- **ROST** (Consumer Discretionary) — RS 90.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=ROST)
- **TGT** (Consumer Discretionary) — RS 89.0, VCP contraction (watch for trigger) [VCP-Watch], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=TGT)
...
- Pivot / buy point: 293.82
- Volume vs 50-day avg: 2.69x
- ADR%: 4.3% | RS score: 91.0
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Setup: continuation breakout, volume 2.69x the 50-day average (needs >= 1.5x)
...
- Setup: Continuation breakout (confirmed)
- Pivot / buy point: 186.96
- Volume vs 50-day avg: 1.66x
- ADR%: 5.4% | RS score: 80.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot / buy point: 143.8
- Volume vs 50-day avg: 1.11x
- ADR%: 4.9% | RS score: 73.0
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 2.28x the 50-day average (needs >= 1.5x)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 170.21
- Volume vs 50-day avg: 0.88x
- ADR%: 2.5% | RS score: 67.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### ZBH — Health Care [chart](https://www.tradingview.com/chart/?symbol=ZBH)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 97.15
- Volume vs 50-day avg: 1.54x
- ADR%: 2.8% | RS score: 48.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 522.25
- Volume vs 50-day avg: 1.19x
- ADR%: 2.8% | RS score: 43.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### WM — Industrials [chart](https://www.tradingview.com/chart/?symbol=WM)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 242.25
- Volume vs 50-day avg: 1.39x
- ADR%: 2.0% | RS score: 32.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 76.17
- Volume vs 50-day avg: 0.93x
- ADR%: 2.1% | RS score: 39.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot / buy point: 1126.63
- Volume vs 50-day avg: 0.76x
- ADR%: 2.5% | RS score: 38.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### PGR — Financials [chart](https://www.tradingview.com/chart/?symbol=PGR)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 234.48
- Volume vs 50-day avg: 0.4x
- ADR%: 2.4% | RS score: 32.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### MSCI — Financials [chart](https://www.tradingview.com/chart/?symbol=MSCI)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot / buy point: 637.24
- Volume vs 50-day avg: 0.82x
- ADR%: 2.7% | RS score: 23.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 45.29
- Volume vs 50-day avg: 0.61x
- ADR%: 2.4% | RS score: 54.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 81.83
- Volume vs 50-day avg: 0.61x
- ADR%: 2.8% | RS score: 69.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 538.23
- Volume vs 50-day avg: 1.18x
- ADR%: 1.9% | RS score: 37.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.39x avg, needs 1.5x)
- Pivot / buy point: 239.8
- Volume vs 50-day avg: 1.39x
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 974.03
- Volume vs 50-day avg: 0.96x
- ADR%: 1.8% | RS score: 22.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### MNST — Consumer Staples [chart](https://www.tradingview.com/chart/?symbol=MNST)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot / buy point: 99.94
...
### KDP — Consumer Staples [chart](https://www.tradingview.com/chart/?symbol=KDP)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 31.67
- Volume vs 50-day avg: 0.84x
- ADR%: 2.5% | RS score: 45.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 14.71
- Volume vs 50-day avg: 0.52x
- ADR%: 0.4% | RS score: 41.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
Market regime reads **defensive**, and **Information Technology** is leading with 47% of its names carrying RS 70+ and 20 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:

- **ZBRA** (Information Technology) — Continuation breakout (confirmed) [Episodic Pivot-Breakout], RS 91.0, pivot 293.82. [chart](https://www.tradingview.com/chart/?symbol=ZBRA)
- **ROST** (Consumer Discretionary) — VCP contraction (watch for trigger), RS 90.0, pivot 252.91. [chart](https://www.tradingview.com/chart/?symbol=ROST)
- **TGT** (Consumer Discretionary) — VCP contraction (watch for trigger) [VCP-Watch], RS 89.0, pivot 149.35. [chart](https://www.tradingview.com/chart/?symbol=TGT)
- **FDX** (Industrials) — VCP contraction (watch for trigger) [VCP-Watch], RS 87.0, pivot 321.02. [chart](https://www.tradingview.com/chart/?symbol=FDX)
