# Momentum Desk — Daily Report (2026-09-22)
...
The market is in a defensive posture, with breadth reading 29% of the scanned universe above its 50-day moving average and 10 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-34.6 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-20.0 pt), while SPY is climbing (+4.0% over 60 sessions, -0.9% over the last two weeks). Momentum under the surface is leaning short -- 4 name(s) hit a fresh 52-week high today against 24 breaking down to a fresh 52-week low. Energy is leading, with 67% of its 21 scanned names carrying an RS score of 70+ and 12 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like MPC, PSX and VLO. With 74 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 761.69 | 10-day MA: 760.03 | 20-day MA: 762.50
...
- Breadth: 29% of the scanned universe above its 50-day MA, 52% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 4 breakouts / 24 breakdowns (out of 518 names evaluated).
- Distribution days (SPY, trailing 25 sessions): 10. Elevated -- a headwind even if price is holding up.
...
|---|---|---|---|---|
| Energy | 21 | 81 | 67% | 12 |
| Health Care | 60 | 76 | 58% | 19 |
| Information Technology | 90 | 74 | 51% | 28 |
| Financials | 70 | 55 | 29% | 6 |
| Materials | 26 | 51 | 23% | 7 |
| Industrials | 77 | 46 | 22% | 11 |
| Consumer Staples | 31 | 41 | 19% | 6 |
| Consumer Discretionary | 53 | 23 | 13% | 3 |
| Communication Services | 22 | 50 | 9% | 2 |
...
- **DELL** (Information Technology) — RS 99.0, Continuation breakout (confirmed), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=DELL)
- **SNDK** (Information Technology) — RS 99.0, Cleared pivot on light volume (unconfirmed — 1.25x avg, needs 1.5x) [VCP-Pivot], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=SNDK)
- **MRNA** (Health Care) — RS 99.0, Cleared pivot on light volume (unconfirmed — 1.13x avg, needs 1.5x) [VCP-Pivot], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=MRNA)
...
- Pivot (breakout trigger level): 421.96
- Entry: next session's open (pivot 421.96 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 3.91x
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Setup: continuation breakout, volume 3.91x the 50-day average (needs >= 1.5x)
...
- Volume vs 50-day avg: 3.55x
- ADR%: 2.8% | RS score: 97.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template) + B (Momentum)
- Setup: Continuation breakout (confirmed)
- Pivot (breakout trigger level): 412.53
- Entry: next session's open (pivot 412.53 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 3.23x
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 97.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 3.23x the 50-day average (needs >= 1.5x)
...
- Pivot (breakout trigger level): 145.13
- Entry: next session's open, only if volume confirms (price is already above pivot 145.13 on light volume)
- Volume vs 50-day avg: 1.13x
- ADR%: 7.8% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 146.73
- Entry: pivot 146.73 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 155.53
- Entry: pivot 155.53 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 3.09x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 17.13
- Entry: pivot 17.13 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.7x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 366.6
- Entry: pivot 366.6 (not yet cleared -- still a live trigger level to watch for)
...
- Volume vs 50-day avg: 3.08x
- ADR%: 2.7% | RS score: 85.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 150.89
- Entry: pivot 150.89 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 2.64x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 265.79
- Entry: pivot 265.79 (not yet cleared -- still a live trigger level to watch for)
...
- Entry: next session's open (pivot 535.25 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 1.51x
- ADR%: 5.7% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 99.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.51x the 50-day average (needs >= 1.5x)

</details>

### SNDK — Information Technology [chart](https://www.tradingview.com/chart/?symbol=SNDK)
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.25x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 1600.62
- Entry: next session's open, only if volume confirms (price is already above pivot 1600.62 on light volume)
- Volume vs 50-day avg: 1.25x
- ADR%: 5.5% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 956.14
- Entry: pivot 956.14 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 108.8
- Entry: pivot 108.8 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.35x avg, needs 1.5x)
- Pivot (breakout trigger level): 545.09
- Entry: next session's open, only if volume confirms (price is already above pivot 545.09 on light volume)
- Volume vs 50-day avg: 1.35x
- ADR%: 3.4% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 251.01
- Entry: pivot 251.01 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.02x
- ADR%: 4.7% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 904.38
- Entry: pivot 904.38 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.51x
- ADR%: 5.0% | RS score: 97.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.28x avg, needs 1.5x)
- Pivot (breakout trigger level): 58.75
- Entry: next session's open, only if volume confirms (price is already above pivot 58.75 on light volume)
...
- Volume vs 50-day avg: 2.19x
- ADR%: 5.0% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Volume vs 50-day avg: 1.96x
- ADR%: 5.6% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 96.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.96x the 50-day average (needs >= 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 383.69
- Entry: pivot 383.69 (not yet cleared -- still a live trigger level to watch for)
...
- Entry: pivot 199.28 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.93x
- ADR%: 4.2% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Volume vs 50-day avg: 2.25x
- ADR%: 5.0% | RS score: 94.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### COHR — Information Technology [chart](https://www.tradingview.com/chart/?symbol=COHR)
- Screens passed: B (Momentum)
- Setup: Continuation breakout (confirmed)
- Pivot (breakout trigger level): 305.37
- Entry: next session's open (pivot 305.37 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 1.6x
- ADR%: 5.6% | RS score: 94.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 94.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.6x the 50-day average (needs >= 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 368.51
- Entry: pivot 368.51 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.93x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 434.62
- Entry: pivot 434.62 (not yet cleared -- still a live trigger level to watch for)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 90.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 3.39x the 50-day average (needs >= 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 338.64
- Entry: pivot 338.64 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 337.0
- Entry: pivot 337.0 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: Continuation breakout (confirmed)
- Pivot (breakout trigger level): 302.05
- Entry: next session's open (pivot 302.05 already cleared at today's close -- don't chase that level)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 378.78
- Entry: pivot 378.78 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 2.07x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 379.49
- Entry: pivot 379.49 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.82x
...
- Volume vs 50-day avg: 2.04x
- ADR%: 1.5% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Volume vs 50-day avg: 1.89x
- ADR%: 3.9% | RS score: 91.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 425.37
- Entry: pivot 425.37 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 2.13x
- ADR%: 2.8% | RS score: 70.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 94.56
- Entry: pivot 94.56 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.35x
- ADR%: 3.8% | RS score: 90.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- **DELL** (Information Technology) — Continuation breakout (confirmed), RS 99.0, pivot 535.25. Entry: next session's open (pivot 535.25 already cleared at today's close -- don't chase that level). [chart](https://www.tradingview.com/chart/?symbol=DELL)
- **LITE** (Information Technology) — VCP contraction (watch for trigger), RS 98.0, pivot 956.14. Entry: pivot 956.14 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=LITE)
- **INTC** (Information Technology) — VCP contraction (watch for trigger), RS 98.0, pivot 108.8. Entry: pivot 108.8 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=INTC)
...
- **MRVL** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 98.0, pivot 251.01. Entry: pivot 251.01 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MRVL)
- **MPC** (Energy) — Continuation breakout (confirmed), RS 97.0, pivot 421.96. Entry: next session's open (pivot 421.96 already cleared at today's close -- don't chase that level). [chart](https://www.tradingview.com/chart/?symbol=MPC)
- **PSX** (Energy) — VCP contraction (watch for trigger), RS 97.0, pivot 274.21. Entry: pivot 274.21 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=PSX)
- **VLO** (Energy) — Continuation breakout (confirmed), RS 97.0, pivot 412.53. Entry: next session's open (pivot 412.53 already cleared at today's close -- don't chase that level). [chart](https://www.tradingview.com/chart/?symbol=VLO)
