# Momentum Desk — Daily Report (2026-09-01)
...
The market is in a defensive posture, with breadth reading 47% of the scanned universe above its 50-day moving average and 6 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-5.6 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-15.2 pt), while SPY is climbing (+3.3% over 60 sessions, -0.9% over the last two weeks). Momentum under the surface is leaning short -- 10 name(s) hit a fresh 52-week high today against 15 breaking down to a fresh 52-week low. Energy is leading, with 71% of its 21 scanned names carrying an RS score of 70+ and 12 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like MPC, VLO and PSX. With 71 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 761.78 | 10-day MA: 766.21 | 20-day MA: 769.21
...
- Breadth: 47% of the scanned universe above its 50-day MA, 65% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 10 breakouts / 15 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 78 | 71% | 12 |
| Health Care | 60 | 76 | 57% | 26 |
| Information Technology | 90 | 62 | 43% | 24 |
| Financials | 70 | 58 | 31% | 20 |
| Materials | 26 | 50 | 27% | 11 |
| Industrials | 77 | 43 | 22% | 21 |
| Consumer Discretionary | 53 | 32 | 21% | 11 |
| Communication Services | 22 | 35 | 14% | 5 |
| Consumer Staples | 31 | 44 | 13% | 9 |
| Real Estate | 29 | 44 | 10% | 12 |
| Utilities | 31 | 28 | 0% | 15 |
| Unknown | 3 | 5 | 0% | 0 |
...
- **LITE** (Information Technology) — RS 98.0, VCP contraction (watch for trigger) [Flag-Watch], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=LITE)
- **HPE** (Information Technology) — RS 97.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=HPE)
...
- Pivot (breakout trigger level): 373.32
- Entry: next session's open, only if volume confirms (price is already above pivot 373.32 on light volume)
- Volume vs 50-day avg: 1.01x
- ADR%: 3.3% | RS score: 97.0
...
- Pivot (breakout trigger level): 358.92
- Entry: next session's open, only if volume confirms (price is already above pivot 358.92 on light volume)
...
- Pivot (breakout trigger level): 246.58
- Entry: next session's open, only if volume confirms (price is already above pivot 246.58 on light volume)
- Volume vs 50-day avg: 1.13x
- ADR%: 3.1% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 134.89 on light volume)
...
- Pivot (breakout trigger level): 206.14
- Entry: next session's open, only if volume confirms (price is already above pivot 206.14 on light volume)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 392.63
- Entry: next session's open, only if volume confirms (price is already above pivot 392.63 on light volume)
...
- Setup: Cleared pivot on light volume (unconfirmed — 0.74x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 402.63
- Entry: next session's open, only if volume confirms (price is already above pivot 402.63 on light volume)
- Volume vs 50-day avg: 0.74x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: Episodic Pivot-Watch
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 96.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
**Pattern tag: Episodic Pivot-Watch** (VCP/Flag/EP classification, additive to the screens above)
...
- Volume vs 50-day avg: 1.38x
- ADR%: 4.4% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.97x avg, needs 1.5x)
- Pivot (breakout trigger level): 31.3
- Entry: next session's open, only if volume confirms (price is already above pivot 31.3 on light volume)
- Volume vs 50-day avg: 0.97x
- ADR%: 4.5% | RS score: 89.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 319.7
- Entry: next session's open, only if volume confirms (price is already above pivot 319.7 on light volume)
- Volume vs 50-day avg: 0.95x
...
- Pivot (breakout trigger level): 130.03
- Entry: next session's open (pivot 130.03 already cleared at today's close -- don't chase that level)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.27x avg, needs 1.5x)
- Pivot (breakout trigger level): 84.63
- Entry: next session's open, only if volume confirms (price is already above pivot 84.63 on light volume)
- Volume vs 50-day avg: 1.27x
- ADR%: 2.4% | RS score: 72.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Continuation breakout (confirmed)
- Pivot (breakout trigger level): 654.91
- Entry: next session's open (pivot 654.91 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 1.88x
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 87.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.88x the 50-day average (needs >= 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 108.49
- Entry: pivot 108.49 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.64x
...
- Pivot (breakout trigger level): 81.93
- Entry: next session's open, only if volume confirms (price is already above pivot 81.93 on light volume)
- Volume vs 50-day avg: 1.07x
- ADR%: 3.3% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- **CRWD** (Information Technology) — VCP contraction (watch for trigger) [Episodic Pivot-Watch], RS 96.0, pivot 225.53. Entry: pivot 225.53 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=CRWD)
- **PANW** (Information Technology) — VCP contraction (watch for trigger), RS 96.0, pivot 396.0. Entry: pivot 396.0 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=PANW)
- **FTNT** (Information Technology) — VCP contraction (watch for trigger), RS 96.0, pivot 172.78. Entry: pivot 172.78 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=FTNT)
...
- **NTAP** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 94.0, pivot 207.08. Entry: pivot 207.08 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=NTAP)

## 5. Other Setups (context)


**Extended / parabolic-short context (not a trade signal by itself):**
- MRNA (Health Care) [chart](https://www.tradingview.com/chart/?symbol=MRNA) — 92.3% above 50-day MA, +145.0% over the last 10 sessions.
