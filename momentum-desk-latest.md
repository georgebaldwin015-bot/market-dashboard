# Momentum Desk — Daily Report (2026-09-03)
...
The market is in a defensive posture, with breadth reading 52% of the scanned universe above its 50-day moving average and 6 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been roughly flat over the last 60 sessions (-1.8 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-5.9 pt), while SPY is climbing (+6.8% over 60 sessions, +0.9% over the last two weeks). Momentum under the surface is leaning firmly long -- 18 name(s) hit a fresh 52-week high today against 5 breaking down to a fresh 52-week low. Energy is leading, with 67% of its 21 scanned names carrying an RS score of 70+ and 13 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like VLO, MPC and PSX. With 81 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 772.80 | 10-day MA: 766.84 | 20-day MA: 769.19
...
- Breadth: 52% of the scanned universe above its 50-day MA, 69% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 18 breakouts / 5 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 77 | 67% | 13 |
| Health Care | 60 | 72 | 57% | 32 |
| Information Technology | 90 | 62 | 46% | 25 |
| Financials | 70 | 62 | 36% | 32 |
| Materials | 26 | 52 | 31% | 13 |
| Consumer Discretionary | 53 | 33 | 19% | 11 |
| Industrials | 77 | 44 | 18% | 25 |
| Consumer Staples | 31 | 40 | 13% | 11 |
| Real Estate | 29 | 40 | 10% | 12 |
| Communication Services | 22 | 38 | 9% | 6 |
| Utilities | 31 | 29 | 0% | 10 |
| Unknown | 3 | 5 | 0% | 0 |

**Leading theme: Energy** — 67% of its 21 scanned names carry an RS score of 70+, and 13 name(s) are clearing a screen outright today.
...
- **DELL** (Information Technology) — RS 98.0, Continuation breakout (confirmed), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=DELL)

**Energy** (11)

### VLO — Energy [chart](https://www.tradingview.com/chart/?symbol=VLO)
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.53x avg, needs 1.5x)
- Pivot (breakout trigger level): 366.09
- Entry: next session's open, only if volume confirms (price is already above pivot 366.09 on light volume)
- Volume vs 50-day avg: 0.53x
- ADR%: 3.1% | RS score: 97.0
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.38x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 387.0
- Entry: next session's open, only if volume confirms (price is already above pivot 387.0 on light volume)
- Volume vs 50-day avg: 0.38x
- ADR%: 3.2% | RS score: 97.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 256.09
- Entry: next session's open, only if volume confirms (price is already above pivot 256.09 on light volume)
- Volume vs 50-day avg: 0.39x
- ADR%: 2.9% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 44.7
- Entry: pivot 44.7 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.38x
- ADR%: 3.3% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 302.25
- Entry: pivot 302.25 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.27x
- ADR%: 2.7% | RS score: 92.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 137.2
- Entry: pivot 137.2 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.36x avg, needs 1.5x)
- Pivot (breakout trigger level): 211.78
- Entry: next session's open, only if volume confirms (price is already above pivot 211.78 on light volume)
- Volume vs 50-day avg: 0.36x
- ADR%: 1.6% | RS score: 82.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 166.15
- Entry: pivot 166.15 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 97.07
- Entry: pivot 97.07 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.25x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 61.52
- Entry: pivot 61.52 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.36x
- ADR%: 2.0% | RS score: 72.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### FANG — Energy [chart](https://www.tradingview.com/chart/?symbol=FANG)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 211.02
- Entry: pivot 211.02 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.25x
- ADR%: 2.5% | RS score: 70.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: Flag-Watch
- Pivot (breakout trigger level): 174.38
- Entry: pivot 174.38 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.45x
- ADR%: 9.4% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  - ADR%: 9.4% (needs >= 3.0% volatility to qualify)
...
- Pivot (breakout trigger level): 298.58
- Entry: pivot 298.58 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.33x
- ADR%: 3.2% | RS score: 96.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### CNC — Health Care [chart](https://www.tradingview.com/chart/?symbol=CNC)
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.37x avg, needs 1.5x)
- Pivot (breakout trigger level): 67.47
- Entry: next session's open, only if volume confirms (price is already above pivot 67.47 on light volume)
- Volume vs 50-day avg: 0.37x
- ADR%: 3.0% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 400.97
- Entry: next session's open, only if volume confirms (price is already above pivot 400.97 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.23x avg, needs 1.5x)
- Pivot (breakout trigger level): 135.97
- Entry: next session's open, only if volume confirms (price is already above pivot 135.97 on light volume)
- Volume vs 50-day avg: 0.23x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.22x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 443.84
- Entry: next session's open, only if volume confirms (price is already above pivot 443.84 on light volume)
- Volume vs 50-day avg: 0.22x
- ADR%: 2.0% | RS score: 91.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 17.09
- Entry: pivot 17.09 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.25x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 129.72
- Entry: pivot 129.72 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.19x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.3x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 275.21
- Entry: next session's open, only if volume confirms (price is already above pivot 275.21 on light volume)
- Volume vs 50-day avg: 0.3x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.25x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 245.49
- Entry: next session's open, only if volume confirms (price is already above pivot 245.49 on light volume)
- Volume vs 50-day avg: 0.25x
...
### BMY — Health Care [chart](https://www.tradingview.com/chart/?symbol=BMY)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 67.92
- Entry: pivot 67.92 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.22x
- ADR%: 2.0% | RS score: 87.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### BAX — Health Care [chart](https://www.tradingview.com/chart/?symbol=BAX)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 27.77
- Entry: pivot 27.77 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.26x
- ADR%: 2.8% | RS score: 86.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 556.75
- Entry: pivot 556.75 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.19x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 245.0
- Entry: pivot 245.0 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.27x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.19x avg, needs 1.5x)
- Pivot (breakout trigger level): 222.67
- Entry: next session's open, only if volume confirms (price is already above pivot 222.67 on light volume)
- Volume vs 50-day avg: 0.19x
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 92.34
- Entry: pivot 92.34 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.09x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 338.61
- Entry: pivot 338.61 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.26x
- ADR%: 2.1% | RS score: 81.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 192.0
- Entry: pivot 192.0 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.21x
...
### HSIC — Health Care [chart](https://www.tradingview.com/chart/?symbol=HSIC)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 90.74
- Entry: pivot 90.74 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.18x
- ADR%: 1.9% | RS score: 78.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.27x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 405.84
- Entry: next session's open, only if volume confirms (price is already above pivot 405.84 on light volume)
- Volume vs 50-day avg: 0.27x
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 265.97
- Entry: pivot 265.97 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.15x
- ADR%: 1.9% | RS score: 71.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 1011.75
- Entry: pivot 1011.75 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.41x
- ADR%: 4.5% | RS score: 99.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 494.51
- Entry: next session's open (pivot 494.51 already cleared at today's close -- don't chase that level)
- Volume vs 50-day avg: 2.0x
- ADR%: 6.0% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 890.17
- Entry: pivot 890.17 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.49x
- ADR%: 7.5% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Trend Template: 8/8 criteria met**
  ...
  - RS score used: 98.0 (needs >= 70 for criterion 8)
**Momentum screen (Qullamaggie-style):**
  - ADR%: 7.5% (needs >= 3.0% volatility to qualify)
  - RS score: 98.0 (needs >= 80 for this screen)
  - Riding the trend: no
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.
**Pattern tag: VCP-Watch** (VCP/Flag/EP classification, additive to the screens above)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 59.82
- Entry: pivot 59.82 (not yet cleared -- still a live trigger level to watch for)
...
- Volume vs 50-day avg: 1.62x
- ADR%: 4.1% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 383.06
- Entry: pivot 383.06 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.24x
...
- Pivot (breakout trigger level): 31.99
- Entry: next session's open, only if volume confirms (price is already above pivot 31.99 on light volume)
- Volume vs 50-day avg: 0.45x
- ADR%: 4.5% | RS score: 90.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 210.5
- Entry: pivot 210.5 (not yet cleared -- still a live trigger level to watch for)
...
- Volume vs 50-day avg: 0.35x
- ADR%: 2.3% | RS score: 84.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 313.16
- Entry: pivot 313.16 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.15x
- ADR%: 2.3% | RS score: 76.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 84.85
- Entry: pivot 84.85 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.31x
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 85.43
- Entry: pivot 85.43 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.29x
- ADR%: 3.0% | RS score: 73.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 227.98
- Entry: pivot 227.98 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.55x
- ADR%: 2.6% | RS score: 70.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 193.62
- Entry: pivot 193.62 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.28x
- ADR%: 2.0% | RS score: 94.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 115.41
- Entry: next session's open, only if volume confirms (price is already above pivot 115.41 on light volume)
- Volume vs 50-day avg: 1.33x
- ADR%: 1.9% | RS score: 89.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### IVZ — Financials [chart](https://www.tradingview.com/chart/?symbol=IVZ)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 33.31
- Entry: pivot 33.31 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.29x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 386.0
- Entry: pivot 386.0 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.35x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 98.1
- Entry: pivot 98.1 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.41x
...
### ALL — Financials [chart](https://www.tradingview.com/chart/?symbol=ALL)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 273.97
- Entry: pivot 273.97 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.24x
...
### NTRS — Financials [chart](https://www.tradingview.com/chart/?symbol=NTRS)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 191.47
- Entry: pivot 191.47 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.21x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 99.95
- Entry: pivot 99.95 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.38x
- ADR%: 1.6% | RS score: 83.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### AIZ — Financials [chart](https://www.tradingview.com/chart/?symbol=AIZ)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 295.49
- Entry: pivot 295.49 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.21x
...
### CF — Materials [chart](https://www.tradingview.com/chart/?symbol=CF)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 139.27
- Entry: pivot 139.27 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.47x
- ADR%: 3.8% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### NUE — Materials [chart](https://www.tradingview.com/chart/?symbol=NUE)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 274.61
- Entry: pivot 274.61 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.27x
- ADR%: 3.3% | RS score: 93.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: Flag-Watch
- Pivot (breakout trigger level): 79.91
- Entry: pivot 79.91 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.42x
- ADR%: 3.5% | RS score: 89.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### STLD — Materials [chart](https://www.tradingview.com/chart/?symbol=STLD)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 268.6
- Entry: pivot 268.6 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.28x
- ADR%: 3.6% | RS score: 88.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Setup: VCP contraction (watch for trigger)
- Pattern tag: VCP-Watch
- Pivot (breakout trigger level): 87.95
- Entry: pivot 87.95 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.25x
- ADR%: 2.1% | RS score: 80.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### CTVA — Materials [chart](https://www.tradingview.com/chart/?symbol=CTVA)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 89.97
- Entry: pivot 89.97 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 64.22
- Entry: pivot 64.22 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.3x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 169.89
- Entry: pivot 169.89 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.2x
- ADR%: 2.9% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pattern tag: Flag-Pivot
- Pivot (breakout trigger level): 151.64
- Entry: next session's open, only if volume confirms (price is already above pivot 151.64 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 89.21
- Entry: pivot 89.21 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.41x
- ADR%: 3.5% | RS score: 84.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 89.35
- Entry: pivot 89.35 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.36x
- ADR%: 2.2% | RS score: 71.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### SWK — Industrials [chart](https://www.tradingview.com/chart/?symbol=SWK)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 104.0
- Entry: pivot 104.0 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.3x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 698.37
- Entry: pivot 698.37 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.76x
- ADR%: 3.0% | RS score: 86.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 190.97
- Entry: pivot 190.97 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.24x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 334.7
- Entry: pivot 334.7 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.17x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 131.84
- Entry: pivot 131.84 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.35x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 85.38
- Entry: pivot 85.38 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.27x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 91.99
- Entry: pivot 91.99 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.3x
- ADR%: 1.4% | RS score: 77.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### WELL — Real Estate [chart](https://www.tradingview.com/chart/?symbol=WELL)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 241.56
- Entry: pivot 241.56 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.24x
...
Market regime reads **defensive**, and **Energy** is leading with 67% of its names carrying RS 70+ and 13 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:

- **MRNA** (Health Care) — VCP contraction (watch for trigger) [Flag-Watch], RS 99.0, pivot 174.38. Entry: pivot 174.38 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MRNA)
- **MU** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 99.0, pivot 1011.75. Entry: pivot 1011.75 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MU)
- **DELL** (Information Technology) — Continuation breakout (confirmed), RS 98.0, pivot 494.51. Entry: next session's open (pivot 494.51 already cleared at today's close -- don't chase that level). [chart](https://www.tradingview.com/chart/?symbol=DELL)
- **LITE** (Information Technology) — VCP contraction (watch for trigger) [VCP-Watch], RS 98.0, pivot 890.17. Entry: pivot 890.17 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=LITE)
- **HPE** (Information Technology) — VCP contraction (watch for trigger), RS 97.0, pivot 59.82. Entry: pivot 59.82 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=HPE)
- **CRWD** (Information Technology) — VCP contraction (watch for trigger), RS 96.0, pivot 225.53. Entry: pivot 225.53 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=CRWD)
- **CRL** (Health Care) — VCP contraction (watch for trigger) [VCP-Watch], RS 96.0, pivot 298.58. Entry: pivot 298.58 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=CRL)
- **APA** (Energy) — VCP contraction (watch for trigger) [Flag-Watch], RS 95.0, pivot 44.7. Entry: pivot 44.7 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=APA)
