...
|---|---|---|
| Financials | 27 | AFL, AIZ, ALL, AON, BAC, BEN, BNY, CB, CBOE, CFG, CPAY, FITB, GL, IBKR, IVZ, JPM, MCO, MET, MTB, NTRS, PFG, PNC, PRU, RF, STT, TRV, USB |
| Health Care | 21 | ABBV, AMGN, BDX, BIIB, BMY, CAH, CNC, CRL, CVS, DGX, DVA, HUM, INCY, IQV, JNJ, LLY, MRK, TECH, UNH, VTRS, WST |
| Industrials | 18 | CSX, DAL, DE, EXPD, FDX, GE, GWW, HON, HWM, LUV, MAS, ODFL, PCAR, ROK, SWK, UAL, UNP, WAB |
...
| Communication Services | 3 | LYV, NWSA, TTWO |
| Utilities | 1 | EIX |

**Read:** strength is clustering in **Financials** (27 name(s) clearing screens). Both traders treat clustering like this as more meaningful than any single stock — check what catalyst or macro theme is driving the group before sizing up individual names.
...
### CASY — Consumer Staples  [chart](https://www.tradingview.com/chart/?symbol=CASY)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 14.42
- Volume vs 50-day avg: 0.92x
- ADR%: 2.9% | RS score: 74.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### TTWO — Communication Services  [chart](https://www.tradingview.com/chart/?symbol=TTWO)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 258.41
