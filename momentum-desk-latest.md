...
The market is in a defensive posture, with breadth reading 27% of the scanned universe above its 50-day moving average and 8 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-36.8 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-12.2 pt), while SPY is climbing (+3.1% over 60 sessions, +0.6% over the last two weeks). Momentum under the surface is leaning short -- 15 name(s) hit a fresh 52-week high today against 43 breaking down to a fresh 52-week low. Energy is leading, with 67% of its 21 scanned names carrying an RS score of 70+ and 9 clearing a screen outright today, with Information Technology also showing real strength. It's being driven by names like VLO, MPC and PSX. With 73 name(s) clearing a screen across 9 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

Market cycle: **Bull** -- equal-weight universe index +4.1% vs its 200-day MA, 50-day MA +6.8% vs the 200-day. Trade normally.
...
- Breadth: 27% of the scanned universe above its 50-day MA, 47% above its 200-day MA.
...
| Health Care | 60 | 75 | 57% | 18 |
| Communication Services | 22 | 52 | 27% | 2 |
| Materials | 26 | 55 | 27% | 2 |
| Industrials | 79 | 43 | 23% | 6 |
| Financials | 70 | 53 | 19% | 2 |
| Consumer Staples | 31 | 44 | 16% | 3 |
| Real Estate | 29 | 39 | 14% | 0 |
| Consumer Discretionary | 53 | 27 | 8% | 3 |
| Utilities | 31 | 23 | 0% | 0 |
| Unknown | 3 | 6 | 0% | 0 |

**Leading theme: Energy** — 67% of its 21 scanned names carry an RS score of 70+, and 9 name(s) are clearing a screen outright today.
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.68x avg, needs 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 152.2
- Entry: pivot 152.2 (not yet cleared -- still a live trigger level to watch for)
...
- Pivot (breakout trigger level): 17.18
- Entry: next session's open, only if volume confirms (price is already above pivot 17.18 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 1189.41
- Entry: pivot 1189.41 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 79.0
- Entry: pivot 79.0 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.67x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.47x avg, needs 1.5x)
...
- Entry: pivot 146.44 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.89x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 89.55
- Entry: pivot 89.55 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.82x
...
Market regime reads **defensive**, and **Energy** is leading with 67% of its names carrying RS 70+ and 9 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:
