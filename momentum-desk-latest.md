# Momentum Desk — Daily Report (2026-08-18)
...
- Pattern tag: VCP-Pivot
- Pivot (breakout trigger level): 52.47
- Entry: next session's open, only if volume confirms (price is already above pivot 52.47 on light volume)
- Volume vs 50-day avg: 0.68x
- ADR%: 1.6% | RS score: 61.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 107.93
- Entry: pivot 107.93 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.47x
- ADR%: 2.6% | RS score: 56.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: pivot 125.18 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.59x
- ADR%: 2.4% | RS score: 64.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
