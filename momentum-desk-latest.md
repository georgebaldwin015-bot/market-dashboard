# Momentum Desk — Daily Report (2026-08-07)
...
The market is in a confirmed uptrend, with breadth reading 65% of the scanned universe above its 50-day moving average and 6 distribution days in the past month -- an elevated count worth watching. A follow-through day fired 2 session(s) ago (+1.8% on rising volume), adding some confidence to the rally attempt. Zooming out, breadth has been improving over the last 60 sessions (+13.0 pt change in % above the 50-day MA) and roughly flat over the last two weeks (-0.4 pt), while SPY is climbing (+4.4% over 60 sessions, +4.0% over the last two weeks). That's a narrow-leadership divergence worth flagging -- SPY's recent climb isn't being confirmed by broader participation. Momentum under the surface is leaning firmly long -- 21 name(s) hit a fresh 52-week high today against 6 breaking down to a fresh 52-week low. Information Technology is leading, with 49% of its 90 scanned names carrying an RS score of 70+ and 17 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like PANW and CPAY. With 28 name(s) clearing a screen across 10 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 768.56 | 10-day MA: 750.44 | 20-day MA: 749.26

**Constructive** — 10-day MA above the 20-day and rising. Long setups get the benefit of the doubt.

- Breadth: 65% of the scanned universe above its 50-day MA, 70% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 21 breakouts / 6 breakdowns (out of 520 names evaluated).
- Distribution days (SPY, trailing 25 sessions): 6. Elevated -- a headwind even if price is holding up.
- Follow-through day: fired 2 session(s) ago (+1.8% on rising volume, rally day 27).
...
|---|---|---|---|---|
| Information Technology | 90 | 68 | 49% | 17 |
| Health Care | 60 | 64 | 47% | 17 |
| Industrials | 77 | 61 | 38% | 19 |
| Energy | 21 | 64 | 33% | 6 |
| Financials | 70 | 57 | 30% | 25 |
| Real Estate | 31 | 45 | 19% | 5 |
| Materials | 26 | 47 | 19% | 5 |
| Consumer Discretionary | 53 | 39 | 19% | 10 |
| Communication Services | 24 | 28 | 17% | 2 |
| Consumer Staples | 31 | 37 | 6% | 2 |
| Utilities | 31 | 32 | 0% | 0 |
| Unknown | 3 | 6 | 0% | 0 |

**Leading theme: Information Technology** — 49% of its 90 scanned names carry an RS score of 70+, and 17 name(s) are clearing a screen outright today.

## 3. Leading Stocks

**Leader spotlight** — the strongest names driving today's leading themes:

- **PANW** (Information Technology) — RS 97.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=PANW)
- **ROST** (Consumer Discretionary) — RS 91.0, Cleared pivot on light volume (unconfirmed — 0.49x avg, needs 1.5x), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=ROST)
- **BNY** (Financials) — RS 89.0, VCP contraction (watch for trigger) [VCP-Watch], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=BNY)
...
**Trend Template: 4/8 criteria met**
  ...
  - ✅ Price within 25% of its 52-week high
  - ❌ RS score >= 70
  - RS score used: 26.0 (needs >= 70 for criterion 8)
**Momentum screen (Qullamaggie-style):**
  - ADR%: 2.7% (needs >= 3.0% volatility to qualify)
  - RS score: 26.0 (needs >= 80 for this screen)
  - Riding the trend: no
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 130.71
- Volume vs 50-day avg: 0.37x
- ADR%: 2.9% | RS score: 76.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
Market regime reads **constructive**, and **Information Technology** is leading with 49% of its names carrying RS 70+ and 17 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:

- **PANW** (Information Technology) — VCP contraction (watch for trigger), RS 97.0, pivot 366.34. [chart](https://www.tradingview.com/chart/?symbol=PANW)
