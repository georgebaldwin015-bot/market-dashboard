...
The market is in a confirmed uptrend, with breadth reading 27% of the scanned universe above its 50-day moving average and 8 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-40.3 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-11.3 pt), while SPY is climbing (+3.3% over 60 sessions, +1.1% over the last two weeks). That's a narrow-leadership divergence worth flagging -- SPY's recent climb isn't being confirmed by broader participation. Momentum under the surface is leaning short -- 6 name(s) hit a fresh 52-week high today against 23 breaking down to a fresh 52-week low. Information Technology is leading, with 59% of its 90 scanned names carrying an RS score of 70+ and 34 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like MU, SNDK and DELL. With 75 name(s) clearing a screen across 10 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

Market cycle: **Bull** -- equal-weight universe index +4.2% vs its 200-day MA, 50-day MA +6.7% vs the 200-day. Trade normally.

SPY close: 767.66 | 10-day MA: 763.86 | 20-day MA: 763.84

**Constructive** — 10-day MA above the 20-day and rising. Long setups get the benefit of the doubt.

- Breadth: 27% of the scanned universe above its 50-day MA, 48% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 6 breakouts / 23 breakdowns (out of 518 names evaluated).
...
**Leading theme: Information Technology** — 59% of its 90 scanned names carry an RS score of 70+, and 34 name(s) are clearing a screen outright today.
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.28x avg, needs 1.5x)
...
- Entry: pivot 363.46 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.1x avg, needs 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.13x avg, needs 1.5x)
...
- Volume vs 50-day avg: 4.38x
- ADR%: 5.0% | RS score: 80.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: Episodic Pivot, gapped 13.6% on a volume surge
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.16x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.17x avg, needs 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 51.14
- Entry: pivot 51.14 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.16x
...
Market regime reads **constructive**, and **Information Technology** is leading with 59% of its names carrying RS 70+ and 34 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:
...
- AKAM (Information Technology) [chart](https://www.tradingview.com/chart/?symbol=AKAM) — gapped 13.6%, opening-range high 128.46, day-low stop reference 115.82.

**Extended / parabolic-short context (not a trade signal by itself):**
- MRNA (Health Care) [chart](https://www.tradingview.com/chart/?symbol=MRNA) — 76.2% above 50-day MA, +34.6% over the last 10 sessions.
