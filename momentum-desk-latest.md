...
The market is in a confirmed uptrend, with breadth reading 27% of the scanned universe above its 50-day moving average and 8 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-40.3 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-11.3 pt), while SPY is climbing (+3.4% over 60 sessions, +1.2% over the last two weeks). That's a narrow-leadership divergence worth flagging -- SPY's recent climb isn't being confirmed by broader participation. Momentum under the surface is leaning short -- 6 name(s) hit a fresh 52-week high today against 30 breaking down to a fresh 52-week low. Energy is leading, with 62% of its 21 scanned names carrying an RS score of 70+ and 9 clearing a screen outright today, with Information Technology also showing real strength. It's being driven by names like VLO, MPC and PSX. With 74 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

Market cycle: **Bull** -- equal-weight universe index +4.1% vs its 200-day MA, 50-day MA +6.7% vs the 200-day. Trade normally.

SPY close: 768.45 | 10-day MA: 763.94 | 20-day MA: 763.88
...
- 52-week breakouts vs breakdowns today: 6 breakouts / 30 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 76 | 62% | 9 |
| Information Technology | 90 | 81 | 59% | 33 |
| Health Care | 60 | 74 | 57% | 22 |
| Industrials | 79 | 46 | 25% | 11 |
| Materials | 26 | 51 | 23% | 3 |
| Communication Services | 22 | 50 | 18% | 1 |
| Financials | 70 | 52 | 17% | 3 |
| Consumer Staples | 31 | 45 | 16% | 4 |
| Real Estate | 29 | 39 | 14% | 1 |
| Consumer Discretionary | 53 | 27 | 9% | 2 |
| Utilities | 31 | 21 | 0% | 1 |
| Unknown | 3 | 5 | 0% | 0 |
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.18x avg, needs 1.5x)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.14x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
...
- Volume vs 50-day avg: 2.89x
- ADR%: 4.9% | RS score: 80.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 2.89x the 50-day average (needs >= 1.5x)
...
- MRNA (Health Care) [chart](https://www.tradingview.com/chart/?symbol=MRNA) — 76.6% above 50-day MA, +35.0% over the last 10 sessions.
