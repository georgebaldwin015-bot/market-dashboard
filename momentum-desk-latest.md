...
The market is in a confirmed uptrend, with breadth reading 27% of the scanned universe above its 50-day moving average and 8 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-40.3 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-11.3 pt), while SPY is climbing (+3.4% over 60 sessions, +1.2% over the last two weeks). That's a narrow-leadership divergence worth flagging -- SPY's recent climb isn't being confirmed by broader participation. Momentum under the surface is leaning short -- 6 name(s) hit a fresh 52-week high today against 27 breaking down to a fresh 52-week low. Energy is leading, with 62% of its 21 scanned names carrying an RS score of 70+ and 9 clearing a screen outright today, with Information Technology also showing real strength. It's being driven by names like MPC, VLO and PSX. With 72 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

Market cycle: **Bull** -- equal-weight universe index +4.2% vs its 200-day MA, 50-day MA +6.7% vs the 200-day. Trade normally.

SPY close: 768.14 | 10-day MA: 763.91 | 20-day MA: 763.87
...
- 52-week breakouts vs breakdowns today: 6 breakouts / 27 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 76 | 62% | 9 |
| Information Technology | 90 | 80 | 59% | 32 |
| Health Care | 60 | 74 | 58% | 21 |
| Industrials | 79 | 46 | 24% | 10 |
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.2x avg, needs 1.5x)
- Pattern tag: VCP-Pivot
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.12x avg, needs 1.5x)
