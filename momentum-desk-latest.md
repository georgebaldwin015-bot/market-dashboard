# Momentum Desk — Daily Report (2026-07-31)
...
The market is in a defensive posture, with breadth reading 62% of the scanned universe above its 50-day moving average and 6 distribution days in the past month -- an elevated count worth watching. Momentum under the surface is mixed -- 5 name(s) hit a fresh 52-week high today against 5 breaking down to a fresh 52-week low. Health Care is leading, with 45% of its 60 scanned names carrying an RS score of 70+ and 23 clearing a screen outright today, with Information Technology also showing real strength. It's being driven by names like VTRS, MRK and LLY. With 49 name(s) clearing a screen across 10 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 747.03 | 10-day MA: 741.30 | 20-day MA: 745.69
...
- Breadth: 62% of the scanned universe above its 50-day MA, 67% above its 200-day MA.
- 52-week breakouts vs breakdowns today: 5 breakouts / 5 breakdowns (out of 520 names evaluated).
...
| Information Technology | 90 | 60 | 43% | 14 |
| Energy | 21 | 67 | 38% | 9 |
| Financials | 70 | 57 | 33% | 23 |
| Industrials | 77 | 54 | 32% | 20 |
| Consumer Discretionary | 53 | 34 | 25% | 14 |
| Real Estate | 31 | 48 | 19% | 6 |
| Materials | 26 | 50 | 19% | 7 |
| Communication Services | 24 | 26 | 17% | 2 |
| Consumer Staples | 31 | 45 | 16% | 6 |
| Utilities | 31 | 39 | 3% | 0 |
| Unknown | 3 | 6 | 0% | 0 |

**Leading theme: Health Care** — 45% of its 60 scanned names carry an RS score of 70+, and 23 name(s) are clearing a screen outright today.

## 3. Leading Stocks

**Leader spotlight** — the strongest names driving today's leading themes:

- **VTRS** (Health Care) — RS 94.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=VTRS)
- **ROST** (Consumer Discretionary) — RS 91.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=ROST)
- **MRK** (Health Care) — RS 90.0, VCP contraction (watch for trigger), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=MRK)
...
- Pivot / buy point: 77.98
- Volume vs 50-day avg: 2.19x
- ADR%: 3.5% | RS score: 75.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 2.19x the 50-day average (needs >= 1.5x)
...
### MCK — Health Care [chart](https://www.tradingview.com/chart/?symbol=MCK)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 889.5
- Volume vs 50-day avg: 0.55x
- ADR%: 2.4% | RS score: 51.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 25.25
- Volume vs 50-day avg: 0.81x
- ADR%: 1.7% | RS score: 40.0
...
- Setup: Continuation breakout (confirmed)
- Pivot / buy point: 1398.45
- Volume vs 50-day avg: 1.54x
- ADR%: 5.1% | RS score: 81.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 1.54x the 50-day average (needs >= 1.5x)
...
- Pivot / buy point: 288.57
- Volume vs 50-day avg: 1.04x
- ADR%: 3.9% | RS score: 66.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 83.1
- Volume vs 50-day avg: 0.83x
- ADR%: 3.3% | RS score: 62.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### PRU — Financials [chart](https://www.tradingview.com/chart/?symbol=PRU)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 123.93
- Volume vs 50-day avg: 0.7x
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 357.31
- Volume vs 50-day avg: 0.68x
- ADR%: 2.1% | RS score: 65.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 119.4
- Volume vs 50-day avg: 0.44x
- ADR%: 1.8% | RS score: 61.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 121.68
- Volume vs 50-day avg: 2.18x
- ADR%: 2.2% | RS score: 57.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 302.65
- Volume vs 50-day avg: 0.62x
- ADR%: 2.1% | RS score: 67.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 243.12
- Volume vs 50-day avg: 0.63x
- ADR%: 2.1% | RS score: 66.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 639.84
- Volume vs 50-day avg: 0.82x
- ADR%: 2.8% | RS score: 59.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 88.27
- Volume vs 50-day avg: 0.79x
- ADR%: 3.4% | RS score: 58.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
**Momentum screen (Qullamaggie-style):**
  ...
  - RS score: 57.0 (needs >= 80 for this screen)
  - Riding the trend: yes, above 10/20-EMA
  - Setup: continuation breakout, volume 2.42x the 50-day average (needs >= 1.5x)
**VCP heuristic:** volatility (ATR%) and volume have been contracting across the last three 10-day blocks — the pattern Minervini describes as a base tightening ahead of a breakout. Confirm this shape visually on the chart; the heuristic can't see the actual price structure, only the numbers.
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 90.51
- Volume vs 50-day avg: 2.63x
- ADR%: 2.4% | RS score: 50.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### LIN — Materials [chart](https://www.tradingview.com/chart/?symbol=LIN)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 546.64
- Volume vs 50-day avg: 2.21x
- ADR%: 2.0% | RS score: 37.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
### GOOG — Communication Services [chart](https://www.tradingview.com/chart/?symbol=GOOG)
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 370.21
...
### GOOGL — Communication Services [chart](https://www.tradingview.com/chart/?symbol=GOOGL)
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 370.92
- Volume vs 50-day avg: 1.36x
- ADR%: 2.8% | RS score: 74.0
- Stage: Stage 1 (Basing)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: VCP forming (pre-breakout)
- Setup: VCP contraction (watch for trigger)
- Pivot / buy point: 26.05
- Volume vs 50-day avg: 0.37x
- ADR%: 2.3% | RS score: 52.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
Market regime reads **defensive**, and **Health Care** is leading with 45% of its names carrying RS 70+ and 23 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:

- **VTRS** (Health Care) — VCP contraction (watch for trigger), RS 94.0, pivot 17.86. [chart](https://www.tradingview.com/chart/?symbol=VTRS)
- **ROST** (Consumer Discretionary) — VCP contraction (watch for trigger), RS 91.0, pivot 252.57. [chart](https://www.tradingview.com/chart/?symbol=ROST)
- **MRK** (Health Care) — VCP contraction (watch for trigger), RS 90.0, pivot 131.82. [chart](https://www.tradingview.com/chart/?symbol=MRK)
- **CASY** (Consumer Discretionary) — VCP contraction (watch for trigger), RS 90.0, pivot 875.25. [chart](https://www.tradingview.com/chart/?symbol=CASY)
- **TGT** (Consumer Discretionary) — VCP contraction (watch for trigger), RS 89.0, pivot 145.9. [chart](https://www.tradingview.com/chart/?symbol=TGT)
- **LLY** (Health Care) — VCP contraction (watch for trigger), RS 87.0, pivot 1235.56. [chart](https://www.tradingview.com/chart/?symbol=LLY)
- **BMY** (Health Care) — Cleared pivot on light volume (unconfirmed — 0.83x avg, needs 1.5x), RS 87.0, pivot 64.86. [chart](https://www.tradingview.com/chart/?symbol=BMY)
- **AIZ** (Financials) — VCP contraction (watch for trigger), RS 86.0, pivot 283.08. [chart](https://www.tradingview.com/chart/?symbol=AIZ)
