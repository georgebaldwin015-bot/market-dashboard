# Momentum Desk — Daily Report (2026-09-23)
...
The market is in a defensive posture, with breadth reading 30% of the scanned universe above its 50-day moving average and 9 distribution days in the past month -- an elevated count worth watching. Zooming out, breadth has been deteriorating over the last 60 sessions (-34.0 pt change in % above the 50-day MA) and deteriorating over the last two weeks (-8.0 pt), while SPY is climbing (+3.1% over 60 sessions, +1.6% over the last two weeks). That's a narrow-leadership divergence worth flagging -- SPY's recent climb isn't being confirmed by broader participation. Momentum under the surface is leaning short -- 13 name(s) hit a fresh 52-week high today against 33 breaking down to a fresh 52-week low. Energy is leading, with 62% of its 21 scanned names carrying an RS score of 70+ and 9 clearing a screen outright today, with Health Care also showing real strength. It's being driven by names like VLO, MPC and PSX. With 76 name(s) clearing a screen across 11 sector(s), there's a workable watchlist below -- see Worth Watching for the shortlist tied to today's regime and themes.

## 1. Market Pulse

SPY close: 767.81 | 10-day MA: 762.21 | 20-day MA: 763.77
...
- 52-week breakouts vs breakdowns today: 13 breakouts / 33 breakdowns (out of 518 names evaluated).
...
|---|---|---|---|---|
| Energy | 21 | 75 | 62% | 9 |
| Health Care | 60 | 74 | 58% | 18 |
| Information Technology | 90 | 78 | 56% | 31 |
| Industrials | 78 | 44 | 29% | 14 |
| Materials | 26 | 54 | 23% | 3 |
| Communication Services | 22 | 48 | 18% | 1 |
| Financials | 70 | 50 | 17% | 5 |
| Consumer Staples | 31 | 42 | 13% | 4 |
| Real Estate | 29 | 37 | 10% | 1 |
| Consumer Discretionary | 53 | 26 | 9% | 3 |
| Utilities | 31 | 23 | 0% | 1 |
| Unknown | 3 | 5 | 0% | 0 |
...
- **MRNA** (Health Care) — RS 99.0, Cleared pivot on light volume (unconfirmed — 0.95x avg, needs 1.5x), Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=MRNA)
...
- **SNDK** (Information Technology) — RS 99.0, Cleared pivot on light volume (unconfirmed — 0.55x avg, needs 1.5x) [Flag-Pivot], Stage: Stage 2 (Uptrend). [chart](https://www.tradingview.com/chart/?symbol=SNDK)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 296.06
- Entry: pivot 296.06 (not yet cleared -- still a live trigger level to watch for)
...
- Pivot (breakout trigger level): 158.83
- Entry: next session's open, only if volume confirms (price is already above pivot 158.83 on light volume)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 366.6 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.49x avg, needs 1.5x)
- Pivot (breakout trigger level): 224.51
- Entry: next session's open, only if volume confirms (price is already above pivot 224.51 on light volume)
- Volume vs 50-day avg: 1.49x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 189.62
- Entry: pivot 189.62 (not yet cleared -- still a live trigger level to watch for)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 150.89 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.55x avg, needs 1.5x)
- Pattern tag: Flag-Pivot
- Pivot (breakout trigger level): 1764.17
- Entry: next session's open, only if volume confirms (price is already above pivot 1764.17 on light volume)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 108.8 on light volume)
- Volume vs 50-day avg: 0.77x
- ADR%: 4.4% | RS score: 98.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 904.38 on light volume)
- Volume vs 50-day avg: 0.7x
...
- Pivot (breakout trigger level): 623.77
- Entry: pivot 623.77 (not yet cleared -- still a live trigger level to watch for)
...
### ARM — Information Technology [chart](https://www.tradingview.com/chart/?symbol=ARM)
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.36x avg, needs 1.5x)
- Pivot (breakout trigger level): 275.61
- Entry: next session's open, only if volume confirms (price is already above pivot 275.61 on light volume)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 231.0 on light volume)
- Volume vs 50-day avg: 1.3x
- ADR%: 6.0% | RS score: 97.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 382.85 on light volume)
...
- Pivot (breakout trigger level): 175.23
- Entry: next session's open, only if volume confirms (price is already above pivot 175.23 on light volume)
- Volume vs 50-day avg: 0.69x
...
- Entry: next session's open, only if volume confirms (price is already above pivot 383.69 on light volume)
- Volume vs 50-day avg: 0.66x
- ADR%: 4.0% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 245.05
- Entry: next session's open, only if volume confirms (price is already above pivot 245.05 on light volume)
- Volume vs 50-day avg: 0.63x
- ADR%: 4.8% | RS score: 95.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 363.3
- Entry: next session's open, only if volume confirms (price is already above pivot 363.3 on light volume)
...
- Pivot (breakout trigger level): 342.03
- Entry: next session's open, only if volume confirms (price is already above pivot 342.03 on light volume)
...
- Pivot (breakout trigger level): 450.1
- Entry: next session's open, only if volume confirms (price is already above pivot 450.1 on light volume)
- Volume vs 50-day avg: 0.79x
- ADR%: 3.4% | RS score: 92.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 205.42
- Entry: pivot 205.42 (not yet cleared -- still a live trigger level to watch for)
...
- Entry: next session's open, only if volume confirms (price is already above pivot 88.35 on light volume)
- Volume vs 50-day avg: 0.77x
- ADR%: 6.0% | RS score: 91.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Pivot (breakout trigger level): 270.87
- Entry: next session's open, only if volume confirms (price is already above pivot 270.87 on light volume)
- Volume vs 50-day avg: 0.82x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 290.13
- Entry: pivot 290.13 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.61x
...
- Entry: pivot 339.75 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.66x
- ADR%: 2.2% | RS score: 83.0
- Stage: Stage 2 (Uptrend)
- Suggested stop reference: Minervini ~7-8% below pivot, or Qullamaggie ~1x ADR below entry (use the tighter of the two)
...
- Entry: pivot 83.79 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 1.03x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 308.18
- Entry: pivot 308.18 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.79x
...
- Entry: next session's open, only if volume confirms (price is already above pivot 698.37 on light volume)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 300.54
- Entry: pivot 300.54 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.87x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 333.58
- Entry: pivot 333.58 (not yet cleared -- still a live trigger level to watch for)
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 234.89
- Entry: pivot 234.89 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.93x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 0.82x avg, needs 1.5x)
- Pivot (breakout trigger level): 435.43
- Entry: next session's open, only if volume confirms (price is already above pivot 435.43 on light volume)
- Volume vs 50-day avg: 0.82x
...
- Screens passed: A (Trend Template)
- Setup: Cleared pivot on light volume (unconfirmed — 1.12x avg, needs 1.5x)
- Pivot (breakout trigger level): 244.84
- Entry: next session's open, only if volume confirms (price is already above pivot 244.84 on light volume)
- Volume vs 50-day avg: 1.12x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 145.96
- Entry: pivot 145.96 (not yet cleared -- still a live trigger level to watch for)
- Volume vs 50-day avg: 0.87x
...
- Screens passed: A (Trend Template)
- Setup: VCP contraction (watch for trigger)
- Pivot (breakout trigger level): 51.28
- Entry: pivot 51.28 (not yet cleared -- still a live trigger level to watch for)
...
Market regime reads **defensive**, and **Energy** is leading with 62% of its names carrying RS 70+ and 9 clearing a screen outright today. On that basis, these 8 name(s) are worth watching:
...
- **AMD** (Information Technology) — VCP contraction (watch for trigger) [Flag-Watch], RS 98.0, pivot 623.77. Entry: pivot 623.77 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=AMD)
...
- **MRVL** (Information Technology) — VCP contraction (watch for trigger), RS 97.0, pivot 262.36. Entry: pivot 262.36 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MRVL)
- **MPC** (Energy) — VCP contraction (watch for trigger), RS 96.0, pivot 424.89. Entry: pivot 424.89 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=MPC)
- **PSX** (Energy) — VCP contraction (watch for trigger), RS 96.0, pivot 274.21. Entry: pivot 274.21 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=PSX)
- **CRL** (Health Care) — VCP contraction (watch for trigger), RS 95.0, pivot 298.58. Entry: pivot 298.58 (not yet cleared -- still a live trigger level to watch for). [chart](https://www.tradingview.com/chart/?symbol=CRL)

## 5. Other Setups (context)


**Extended / parabolic-short context (not a trade signal by itself):**
- MRNA (Health Care) [chart](https://www.tradingview.com/chart/?symbol=MRNA) — 73.7% above 50-day MA, +34.3% over the last 10 sessions.
